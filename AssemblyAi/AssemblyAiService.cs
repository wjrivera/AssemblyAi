...
namespace AssemblyAi
{
	public class AssemblyAiService : IAssemblyAiService
	{
        ...
        public async Task<TranscriptionResponse> UploadAudioFileAsync(TranscriptionRequest transcriptionRequest)
        {
            return await _helper.SubmitUploadAsync(transcriptionRequest);
        }
